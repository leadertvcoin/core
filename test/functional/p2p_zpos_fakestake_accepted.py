...
from fake_stake.base_test import LeadERTVCoin_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(LeadERTVCoin_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zltvstake']] * self.num_nodes
