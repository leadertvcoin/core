Contributing to LeadERTVCoin Core
============================

The LeadERTVCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/leadertvcoin-project/leadertvcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LeadERTVCoin Core project, and is not to be
confused with overall LeadERTVCoin Network Protocol consensus changes.

Whether a pull request is merged into LeadERTVCoin Core rests with the project merge
...
Patches that change LeadERTVCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the LeadERTVCoin consensus, it must have been
...
The project leader is the release manager for each LeadERTVCoin Core release.
