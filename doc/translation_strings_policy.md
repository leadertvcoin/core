...
This document provides guidelines for internationalization of the LeadERTVCoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to LeadERTVCoin network</numerusform>
            <numerusform>%n active connections to LeadERTVCoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `leadertvcoin_en.ts` remains unchanged.
