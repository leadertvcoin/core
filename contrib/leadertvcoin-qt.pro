...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/leadertvcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/leadertvcoin-cli.cpp \
           src/leadertvcoin-tx.cpp \
           src/leadertvcoin.cpp \
           src/db.cpp \
           ...
           src/test/test_leadertvcoin.cpp \
...
RESOURCES += src/qt/leadertvcoin.qrc src/qt/leadertvcoin_locale.qrc

TRANSLATIONS += src/qt/locale/leadertvcoin_bg.ts \
                src/qt/locale/leadertvcoin_de.ts \
                src/qt/locale/leadertvcoin_en.ts \
                src/qt/locale/leadertvcoin_es.ts \
                src/qt/locale/leadertvcoin_fi.ts \
                src/qt/locale/leadertvcoin_fr.ts \
                src/qt/locale/leadertvcoin_it.ts \
                src/qt/locale/leadertvcoin_ja.ts \
                src/qt/locale/leadertvcoin_pl.ts \
                src/qt/locale/leadertvcoin_pt.ts \
                src/qt/locale/leadertvcoin_ru.ts \
                src/qt/locale/leadertvcoin_sk.ts \
                src/qt/locale/leadertvcoin_sv.ts \
                src/qt/locale/leadertvcoin_vi.ts \
                src/qt/locale/leadertvcoin_zh_CN.ts \
                src/qt/locale/leadertvcoin_zh_TW.ts
