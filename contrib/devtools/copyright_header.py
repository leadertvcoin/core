...
EXCLUDE = [
    # auto generated:
    'src/qt/leadertvcoinstrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The LeadERTVCoin developers'
...
Arguments:
    <base_directory> - The base directory of a leadertvcoin source code repository.
"""
