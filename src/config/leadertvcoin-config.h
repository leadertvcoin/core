/* src/config/leadertvcoin-config.h.  Generated from leadertvcoin-config.h.in by configure.  */
/* src/config/leadertvcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.leadertvcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LeadERTVCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LeadERTVCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "leadertvcoin"
