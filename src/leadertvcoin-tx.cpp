...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LeadERTVCoin Core leadertvcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  leadertvcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded leadertvcoin transaction") + "\n" +
                               "  leadertvcoin-tx [options] -create [commands]   " + _("Create hex-encoded leadertvcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded leadertvcoin transaction
