...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop LeadERTVCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "LeadERTVCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LeadERTVCoin features */
        {"leadertvcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"leadertvcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"leadertvcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"leadertvcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"leadertvcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"leadertvcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"leadertvcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"leadertvcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"leadertvcoin", "startmasternode", &startmasternode, true, true, false},
        {"leadertvcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"leadertvcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"leadertvcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"leadertvcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"leadertvcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"leadertvcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"leadertvcoin", "preparebudget", &preparebudget, true, true, false},
        {"leadertvcoin", "submitbudget", &submitbudget, true, true, false},
        {"leadertvcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"leadertvcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"leadertvcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"leadertvcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"leadertvcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"leadertvcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"leadertvcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"leadertvcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"leadertvcoin", "mnsync", &mnsync, true, true, false},
        {"leadertvcoin", "spork", &spork, true, true, false},
        {"leadertvcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzltvseed", &getzltvseed, false, false, true},
        {"zerocoin", "setzltvseed", &setzltvseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzltv", &searchdzltv, false, false, true},
        {"zerocoin", "dzltvstate", &dzltvstate, false, false, true},
...
{
    return "> leadertvcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16313/\n";
}
