...
/** Utility functions used by the LeadERTVCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LeadERTVCoin addresses in monospace font
...
// Parse "leadertvcoin:" URI into recipient object, return true on successful parsing
