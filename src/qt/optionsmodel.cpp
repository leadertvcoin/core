...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::LTV);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeLeadERTVCoinAmount"))
        SoftSetArg("-anonymizeleadertvcoinamount", settings.value("nAnonymizeLeadERTVCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in leadertvcoin.cpp during shotdown to also remove the window positions
