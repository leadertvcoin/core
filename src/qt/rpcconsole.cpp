                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLTVPathCustom = GetArg("-zltvbackuppath", "");
    ...
    if(!strzLTVPathCustom.empty()) {
        ui->wallet_customzltvbackuppath->setText(QString::fromStdString(strzLTVPathCustom));
        ui->wallet_customzltvbackuppath_label->setVisible(true);
        ui->wallet_customzltvbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLTVPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LeadERTVCoin RPC console.") + "<br>" +
