...
/* LeadERTVCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LeadERTVCoin"
#define QAPP_ORG_DOMAIN "leadertvcoin.org"
#define QAPP_APP_NAME_DEFAULT "LeadERTVCoin-Qt"
#define QAPP_APP_NAME_TESTNET "LeadERTVCoin-Qt-testnet"
