...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LeadERTVCoin Core"),
     ...
     * override -datadir in the leadertvcoin.conf file in the default data directory
     * (to be consistent with leadertvcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
