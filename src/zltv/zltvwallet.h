...
#ifndef LeadERTVCoin_ZLTVWALLET_H
#define LeadERTVCoin_ZLTVWALLET_H
...
public:
    CzLTVWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLTV(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLTV(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //LeadERTVCoin_ZLTVWALLET_H
