...
#ifndef LeadERTVCoin_ZLTVTRACKER_H
#define LeadERTVCoin_ZLTVTRACKER_H
...
public:
    CzLTVTracker(std::string strWalletFile);
    ~CzLTVTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLTVWallet* zLTVWallet = NULL);
...
#endif //LeadERTVCoin_ZLTVTRACKER_H
